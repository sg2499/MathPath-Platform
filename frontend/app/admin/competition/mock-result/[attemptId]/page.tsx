        ...
        <div className="math-card p-6">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="rounded-[24px] border border-[#2563eb]/25 bg-[#2563eb]/5 px-6 py-4 text-center dark:border-cyan-300/30 dark:bg-cyan-400/10">
              <p className="text-[11px] font-black uppercase tracking-[0.18em] text-[#2563eb] dark:text-cyan-100">
                Score
              </p>
      ...
      <div className="relative flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex gap-4">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="rounded-full border border-[#2563eb]/20 bg-white px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-[#2563eb] dark:border-cyan-300/30 dark:bg-cyan-400/10 dark:text-cyan-100">
                {message.badge}
              </span>
            </div>
        ...
        <div className="grid min-w-0 gap-3 lg:w-[360px]">
          <div className="rounded-[24px] border border-[#2563eb]/20 bg-white/90 p-4 dark:border-cyan-300/30 dark:bg-slate-950/70">
            <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[#2563eb] dark:text-cyan-100">
              Focus Next
            </p>
