...
function PracticeRowsTable({
  ...
  const GridColumns = ShowBenchmark
    ? "grid-cols-[minmax(142px,.96fr)_minmax(100px,.5fr)_minmax(140px,.58fr)_minmax(82px,.4fr)_minmax(90px,.44fr)_minmax(124px,.58fr)_minmax(100px,.48fr)_minmax(142px,.66fr)_136px]"
    : "grid-cols-[minmax(142px,1fr)_minmax(100px,.52fr)_minmax(140px,.62fr)_minmax(82px,.42fr)_minmax(90px,.46fr)_minmax(100px,.5fr)_minmax(142px,.7fr)_136px]";
