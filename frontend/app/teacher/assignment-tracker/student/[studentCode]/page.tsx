...
function PracticeRowsTable({
  ...
  const GridColumns = ShowBenchmark
    ? "grid-cols-[minmax(142px,.96fr)_minmax(100px,.5fr)_minmax(170px,.58fr)_minmax(82px,.4fr)_minmax(90px,.44fr)_minmax(240px,.84fr)_minmax(136px,.64fr)_minmax(170px,.74fr)_136px]"
    : "grid-cols-[minmax(142px,1fr)_minmax(100px,.52fr)_minmax(170px,.62fr)_minmax(82px,.42fr)_minmax(90px,.46fr)_minmax(136px,.64fr)_minmax(170px,.74fr)_136px]";
