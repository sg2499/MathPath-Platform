...
export function ConfirmDialog({
  ...
  return (
    <div className="math-dialog-overlay fixed inset-0 z-[99999] bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="math-panel w-full max-w-md p-6 math-pop-in bg-white/95 dark:bg-slate-950/95 border-slate-200 dark:border-slate-800 shadow-[0_0_50px_rgba(0,0,0,0.3)]">
