...
export function Metric({
  ...
  return (
    <div className={`math-teacher-light-metric-card group relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl rounded-[24px] border border-rose-200/70 bg-white/85 p-4 shadow-sm ring-1 ring-rose-100/80 dark:border-white/10 dark:bg-slate-950/75 dark:ring-white/10 ${className}`}>
      {/* Gamified hover shine */}
      <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/40 to-transparent opacity-0 transition-all duration-700 group-hover:translate-x-full group-hover:opacity-100" />
...
export function CompactRecordTable({
  ...
  const GridColumns = hideLessonColumn
    ? showAttemptColumn
      ? "grid-cols-[minmax(150px,1fr)_minmax(104px,.54fr)_minmax(170px,.6fr)_minmax(84px,.42fr)_minmax(94px,.48fr)_minmax(240px,.84fr)_minmax(136px,.64fr)_minmax(146px,.68fr)_minmax(118px,.54fr)]"
      : "grid-cols-[minmax(150px,1fr)_minmax(170px,.6fr)_minmax(84px,.42fr)_minmax(94px,.48fr)_minmax(240px,.84fr)_minmax(136px,.64fr)_minmax(146px,.68fr)_minmax(118px,.54fr)]"
    : showAttemptColumn
      ? "grid-cols-[minmax(132px,.74fr)_minmax(150px,1fr)_minmax(104px,.54fr)_minmax(170px,.6fr)_minmax(84px,.42fr)_minmax(94px,.48fr)_minmax(240px,.84fr)_minmax(136px,.64fr)_minmax(146px,.68fr)_minmax(118px,.54fr)]"
      : "grid-cols-[minmax(132px,.74fr)_minmax(150px,1fr)_minmax(170px,.6fr)_minmax(84px,.42fr)_minmax(94px,.48fr)_minmax(240px,.84fr)_minmax(136px,.64fr)_minmax(146px,.68fr)_minmax(118px,.54fr)]";
