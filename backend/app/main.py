...
def on_startup():
    ...
    ensure_attempt_punctuality_status_column()
    ...
    ensure_level_next_level_id_column()
    ensure_assignment_notified_at_column()
    ensure_assignments_assigned_to_id_indexed()
    ...
    ensure_annual_competition_tables()
    ensure_annual_competition_go_live_columns()
