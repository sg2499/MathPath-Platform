...
DPS_TITLES = {1: {1: 'Decimal Number Add-Less (Visual)',
 ...
 3: {1: 'Decimal Number Add-Less (Visual)',
     2: '20 x 20 and 40 + 2D Visual',
     3: '30 x 2D and 5D ÷ 2D Visual',
 ...
 21: {1: 'Mixed Digit Add-Less (Visual)',
      2: 'Multiplication and Division by 30',
      3: 'Multiplication and Division by 50',
 ...
 28: {1: 'Cubes and Squares (Visual)',
      2: 'Multiplication by 30 and 5D x 2D',
