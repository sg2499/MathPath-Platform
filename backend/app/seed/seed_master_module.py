...
DPS_TITLES = {1: {1: 'Decimal Number Add-Less (Visual)',
 ...
 9: {1: '5D ÷ 2D and Decimal Multiplication Visual',
     ...
     4: 'Borrowing Sums with Positive and Negative Answers',
 ...
 22: {1: 'BODMAS',
      ...
      3: 'Borrowing Sums with Positive and Negative Answers',
...
SECTION_TITLE_NORMALISATIONS = {
    ...
    "borrowing sums with positive negative answers": "Borrowing Sums with Positive and Negative Answers",
    "borrowing sums with positive and negative answers": "Borrowing Sums with Positive and Negative Answers",
}
...
def _split_mm_title_parts(title: str) -> list[str]:
    ...
    protected = {
        ...
        "Skill Stacker": "Skill Stacker",
        "Concept Drill": "Concept Drill",
        "Borrowing Sums with Positive and Negative Answers": "Borrowing Sums with Positive Negative Answers",
